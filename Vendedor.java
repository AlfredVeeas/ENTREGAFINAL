...
public class Vendedor implements Compra{
    ...
    public Vendedor(int Puesto, String NombreV, String RUT, String HoraAtencion) {
        this.Puesto = Puesto;
    ...
    public void CrearVendedor(){ //registro de un nuevo vendedor
        ...
        SwingVendedor vendedorUI2 = new Swing
        */
        SwingVendedor vendedorUI2 = new SwingVendedor();
        vendedorUI2.setVisible(true);
    ...
    public boolean ValidarFormatoRut(String rut) throws FormatoRutException {
        boolean flag=false;
        
        if((rut.indexOf('.')==2)&&(rut.indexOf('-')==10)){
            flag = true;
        }else{
            throw new FormatoRutException();
