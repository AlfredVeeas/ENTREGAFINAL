...
public class Feria {
    ...
    public Feria(String IDFeria, String NombreFeria, String DireccionFeria) {
    ...
    public void IngresarFeria(){
        ...
        SwingFeria feriaGui = new SwingFeria();
        feriaGui.setVisible(true);
    ...
    public void ModificarFeria(String ID){
    ...
    public void EliminarFeria(String ID){
        for(int i = 0 ; i<LFeria.size() ; i++){
            if(LFeria.get(i).getNombreFeria().equals(NombreFeria)){
                LFeria.remove(i);
            }
